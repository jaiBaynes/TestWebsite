...
zeus = Image.create!(
  ...
  biography: "Jupiter Solaris is a being that does not belong in the world of Greek Mythology. Nonetheless, he and his fellow Solaris inserted themselves into it and took on the roles of various myth characters. Jupiter, having gotten way to into his role as Zeus the god of thunder is forgetting his Solaris origin and slowly being assimilated by it. As Zeus he fulfills Fate: overthrowing the Titans, ruling the Kosmos and siring heroes. Despite being an anomoly himself, he has become obsessed with preserving Fate and destroying anything that tries to change the world from the stories of myth. In that regard his chief enemies are Hades and Hydra. His biggest threats (though they claim to be on his side) are the other Solaris members who while acting as greek gods aren't nearly as into their roles as Zeus is.",
  ...
  home: "Olympus",
  personality: "Proud, selfish, greedy, wily, lazy, partisan, petty, vindictive, violent",
...
hercules = Image.create!(
  ...
  biography: "The son of Zeus and Alcmene, Hercules iwas born in Thebes alongside his more obscure twin brother Iphicles. Aware of his destiny from a young age he applied himself, preparing to be the greatest hero. His first major exploit was winning the war against the Minyans for his city Thebes. As a reward he was granted Princess Megara as his wife. After winning the war, he retired from the army and went into hero work, traveling the world and slaying monsters. After building enough of a repetoir he was approached by Olympus with 12 Labors to prove he was the greatest hero. Upon completing them he was promised a seat on Olympus alongside his father Zeus.",
  ...
  home: "Thebes",
  personality: "Proud, Fun-loving, adventurous, petty, tempermental",
  first_appearance: "Act 1",
...
hebe = Image.create!(
  ...
  biography: "The daughter of Zeus and Metis and princess of Olympus. Due to her toxic home life and neglectful parents, she frequently ran away frm home. One of the main places she'd hide was at her half-brother Hercules' house where she grew close to him and his family. However, after Hercules left for years to hunt monsters and be a hero, Hebe felt abandoned. She instead started hiding from her father in the Underworld with her uncle Hades. She became incredibly close to her cousin Kat. When Kat was away for a year, she decided to go back to Megara, Hercules' wife and was shocked to see he had abandoned them too. She resolved to stay and help them... and give that jerk Hercules a piece of her mind when she saw him again.",
  ...
  home: "Olympus",
  personality: "Sweet, kind, caring, passionate, petty, jealous, ditsy, empathetic",
  first_appearance: "Act 1",
...
neptune = Image.create!(
  gallery: olympia_gallery,
  name: "Neptune",
  quote: "Saving the world is a childish notion; even for a god. The whole world is too big to save; focus on saving those you care about.",
  family: "Zeus (brother), Mercury (brother), Venus (sister), Terra (sister), Uranus (sister)",
  biography: "A Solaris that has taken on the role of Poseidon from Greek mythology. Unlike Zeus, he doesn't feel obligated to serve Fate, however he does recognize it as a force beyond his powers. Neptune seeks to defy Fate to protect those he cares about. To that end, he raised Hydra, a being whose existance was so different from Fate that he might be able to violate it. It public Neptune is on Jupiter's side but behind the scenes he plots to destroy him since he is an unstable threat to those Neptune cares about.",
  ...
  home: "Olympus",
  personality: "cold, pragmatic, selfish, proud, violent, doting, selectively loving, ruthless, protective, vengeful",
  first_appearance: "Act 1",
  race: "Solaris",
